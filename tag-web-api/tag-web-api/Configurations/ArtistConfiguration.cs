...
public class ArtistConfiguration : IEntityTypeConfiguration<Artist>
{
    ...
    private static void SeedData(EntityTypeBuilder<Artist> builder)
    {
        builder.HasData(
            ...
            new Artist { ArtistID = 7, Title = "Campfire Cirque", Byline = "Fire Flow Performance Artist", Statement = "Long statement about how qualified i am!", SEOTags = "fire, poi", Path = "CampfireCirque", ProfilePicID = 17, CoverPicID = 18 });
    }
}
