    ...
    public class Forms_FieldConfiguration : IEntityTypeConfiguration<Forms_Field>
    {
        ...
        private static void SeedData(EntityTypeBuilder<Forms_Field> builder)
        {
            builder.HasData(
                ...
                new Forms_Field { Forms_FieldID = 101, Forms_MetadataID = 3, Name = "path", ClassName = "styles.input", Type = "text", Placeholder = "Slug (auto-generated from title)", DefaultValue = "", Label = "Slug", RegexValidationPattern = "validate_string", IsReadOnly = true },
                ...
                new Forms_Field { Forms_FieldID = 211, Forms_MetadataID = 7, Name = "path", ClassName = "styles.input", Type = "text", Placeholder = "Path (auto-generated from title)", DefaultValue = "", Label = "Path", RegexValidationPattern = "validate_string", IsReadOnly = true },
                ...
                new Forms_Field { Forms_FieldID = 304, Forms_MetadataID = 8, Name = "path", ClassName = "styles.input", Type = "text", Placeholder = "Path (auto-generated from title)", DefaultValue = "", Label = "Path", RegexValidationPattern = "validate_string", IsReadOnly = true },
